...
function loadPackageJson(root = './') {
    return __awaiter(this, void 0, void 0, function* () {
        return JSON.parse(yield readFile(path_1.default.join(root, 'package.json'), 'utf-8'));
    });
}
...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield outputs.setVersions(settings.version, settings.bump, settings.prereleaseId);
...
function setOutputs(outputs) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.setOutput('prerelease', String((_d = outputs.version) === null || _d === void 0 ? void 0 : _d.prerelease));
        ...
        core.setOutput('next-snapshot-major', String((_h = outputs === null || outputs === void 0 ? void 0 : outputs.nextSnapshotVersion) === null || _h === void 0 ? void 0 : _h.major));
        core.setOutput('next-snapshot-minor', String((_j = outputs === null || outputs === void 0 ? void 0 : outputs.nextSnapshotVersion) === null || _j === void 0 ? void 0 : _j.minor));
        core.setOutput('next-snapshot-patch', String((_k = outputs === null || outputs === void 0 ? void 0 : outputs.nextSnapshotVersion) === null || _k === void 0 ? void 0 : _k.patch));
    });
}
...
class Outputs {
     ...
     */
    setVersions(version, bump, prereleaseId) {
        return __awaiter(this, void 0, void 0, function* () {
            this.snapshotRelease = version.endsWith('-SNAPSHOT');
            this.version = new semver_1.SemVer(version);
            if (bump) {
                this.nextVersion = new semver_1.SemVer(`${this.version}`).inc(bump, prereleaseId);
